angular.module('app', ['ngMask', 'ngDialog'])
  .controller('Lead', function($scope, $log, $http, $location, ngDialog, $httpParamSerializerJQLike){
     ...
     var registra_acesso = function() {
         $http.get(host + '/api/registraAcesso/zsyaFFLfMCv4wI-Dckod4UmnmV3j11mEQfGHvJlDP_8')
             ...
             if (!retorno.error) {
               ...
               function(){
                ...
                if ($scope.enviarwpp == true) {
                  window.location.href = "https://api.whatsapp.com/send?phone=558587670229&text=Olá, me chamo  "+dados.LE_Nome+"   e gostaria de receber mais informações sobre os modelos da Extrema Land Rover.";
                }
                else {
